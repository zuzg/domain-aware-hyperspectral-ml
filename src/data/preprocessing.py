...
def mean_to_bias(bias_mean: np.ndarray, divisor: np.ndarray, device: str, img_size: int, batch_size: int) -> Tensor:
...
def mean_path_to_bias(mean_path: Path, divisor: np.ndarray, device: str, img_size: int, batch_size: int) -> Tensor:
